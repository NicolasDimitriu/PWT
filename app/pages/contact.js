  ...
  return (
    <Layout>
      ...
      <form className="[&_span]:block grid gap-3" onSubmit={onSubmit}>
        ...
        <div>
          <button
            className='focus:outline-none text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-slate-400 dark:focus:ring-slate-400'
          >
            Send
          </button>
        </div>
